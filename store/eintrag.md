...
```powershell
tar -a -c -f store/ki-text-finder-0.3.0.zip manifest.json background.js content.js heuristik.js ampel.js modelle.js popup.html popup.js options.html options.js icons
```
